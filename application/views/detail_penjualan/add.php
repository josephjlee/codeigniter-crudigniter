    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Detail Penjualan Add</h3>
            </div>
            <?php echo form_open('detail_penjualan/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="detail_penjualan_nota" class="form-control">
								...
								{
									$selected = ($penjualan['penjualan_id'] == $this->input->post('detail_penjualan_nota')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="detail_produk_id" class="form-control">
								...
								{
									$selected = ($produk['produk_id'] == $this->input->post('detail_produk_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="detail_jumlah_beli" value="<?php echo $this->input->post('detail_jumlah_beli'); ?>" class="form-control" id="detail_jumlah_beli" />
