    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Kasir Add</h3>
            </div>
            <?php echo form_open('kasir/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="kasir_nama" class="control-label"><span class="text-danger">*</span>Kasir Nama</label>
						<div class="form-group">
							<input type="text" name="kasir_nama" value="<?php echo $this->input->post('kasir_nama'); ?>" class="form-control" id="kasir_nama" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="kasir_email" value="<?php echo $this->input->post('kasir_email'); ?>" class="form-control" id="kasir_email" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="kasir_telepon" value="<?php echo $this->input->post('kasir_telepon'); ?>" class="form-control" id="kasir_telepon" />
