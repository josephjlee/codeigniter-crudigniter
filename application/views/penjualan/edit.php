<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('penjualan/edit/'.$penjualan['penjualan_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="penjualan_kasir_id" class="form-control">
								...
								{
									$selected = ($kasir['kasir_id'] == $penjualan['penjualan_kasir_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="penjualan_nota" value="<?php echo ($this->input->post('penjualan_nota') ? $this->input->post('penjualan_nota') : $penjualan['penjualan_nota']); ?>" class="form-control" id="penjualan_nota" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="penjualan_tgl" value="<?php echo ($this->input->post('penjualan_tgl') ? $this->input->post('penjualan_tgl') : $penjualan['penjualan_tgl']); ?>" class="has-datepicker form-control" id="penjualan_tgl" />
