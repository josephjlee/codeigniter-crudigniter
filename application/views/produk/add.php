    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Produk Add</h3>
            </div>
          		...
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="produk_nama" value="<?php echo $this->input->post('produk_nama'); ?>" class="form-control" id="produk_nama" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="produk_harga" value="<?php echo $this->input->post('produk_harga'); ?>" class="form-control" id="produk_harga" />
